...
Якщо цей парсер був для вас корисним, будь ласка, підтримайте мене — і подаруйте трохи любові Комуджі 🐈‍⬛:

👉 [**Підтримати Комуджі**](https://cppsharp.github.io/#donate)

![Komugi and Komaru](files/komugi_and_komaru.png)

Якщо зараз не можете зробити пожертву, ви все одно можете підтримати проект, поставивши йому ⭐.  
Дякую
